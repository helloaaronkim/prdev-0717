...
# Creates an asset for the student manual of the devprd-course (APDevPRDev) based on the current state of this repo.
...
#
# Usage: create-student-manual-asset-for-devprd.sh
...
assetname="$course1""_studentManual_$today" # APDevPRDev_studentManual_07may2020
assetfile="$assetname.pdf"                  # APDevPRDev_studentManual_07may2020.pdf

echo "Creating $assetfile"
cd $assetsdir
rm -f $assetfile
cp "$manual1" $assetfile
